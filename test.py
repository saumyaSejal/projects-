...
class Login:
   ...
   def loginform(self):
      ...
      label2=Label(frame_input,text="AADHAR NO.",font=("Goudy old style",20,"bold"),
      ...
      label3=Label(frame_input,text="voter Id",font=("Goudy old style",20,"bold"),
   ...
   def logincheck(self):
      ...
      if self.adharverf.get()=="" or self.voteridverf.get()=="":
         ...
         try:
            ...
            e1=dec[:idx]
            cipher1=dec[idx+1:]
            print("e-",e1,"cipher-",cipher1)
            viddec= rsamod.decryption(e1,cipher1)
            print("decrypted- ",viddec)
            print("adharfield=",self.adharverf.get(),"vidverf=",self.voteridverf.get())
   ...
   def register(self):
      ...
      label1=Label(frame_input2,text="Registration",font=('impact',32,'bold'),
      ...
      label2=Label(frame_input2,text="Aadhar number",font=("Goudy old style",20,"bold"),
      ...
      if self.adhar.get()==""or self.name.get()==""or self.age.get()==""or self.email.get()=="":
         ...
         try:
            ...
            if (row!=None or row2 != None):
               ...
               a=voterid.sendvoterid(self.email.get())
               enc=rsamod.encryption(a)
   ...
   def storevote(self):
         ...
         ''' print(hashed)
         print("hexadecimal equivalent=",hashed.hexdigest())
         print("hash string=",str(hashed))
         print("og hashed=",len(str(hashed)),"hexadecimal hashed=",len(str(hashed.hexdigest())))'''
         ...
         try:
            ...
            if(row != None):
               ...
               cur.execute("insert into votes values(%s,%s)"
                           ...
                           ,(self.adharverf.get(),str(self.code)))
