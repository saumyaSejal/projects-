...
seqA = 'TTGTCTCGTAATGATCTTAC'
seqB = 'TTAGACGACGATGCTATCGA'
...
def Graphical_display(seqA_aligned, seqB_aligned):
    ...
    for i in range(0, alength, 60):
        ...
        print('seqA  {0:<4}  {1}  {2:<4}'.format(i + 1, seqA_slice, i + len(seqA_slice)))
        print('             {0}'.format(alignment_str[i:i+60]))
        seqB_slice = seqB_aligned[i:i+60]
        print('seqB  {0:<4}  {1}  {2:<4}'.format(i + 1, seqB_slice, i + len(seqB_slice)))
        print()
